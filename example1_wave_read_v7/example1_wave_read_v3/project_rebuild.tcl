...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ad_ch1_data [ create_bd_port -dir I -from 11 -to 0 ad_ch1_data ]
  set ad_ch1_otr [ create_bd_port -dir I ad_ch1_otr ]
  set key [ create_bd_port -dir I -from 3 -to 0 key ]
  set led [ create_bd_port -dir O -from 3 -to 0 led ]
  set ad_ch1_clk [ create_bd_port -dir O -type clk ad_ch1_clk ]
  set da1_data [ create_bd_port -dir O -from 13 -to 0 da1_data ]
  set da1_clk [ create_bd_port -dir O -type clk da1_clk ]
  set da1_wrt [ create_bd_port -dir O da1_wrt ]
  set da2_data [ create_bd_port -dir O -from 13 -to 0 da2_data ]
  set da2_clk [ create_bd_port -dir O -type clk da2_clk ]
  set da2_wrt [ create_bd_port -dir O da2_wrt ]
...
\
  ...
  # Create instance: top_system_0, and set properties
  set block_name top_system
  set block_cell_name top_system_0
  if { [catch {set top_system_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $top_system_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins axi_smc/M03_AXI] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net top_system_0_m_axis [get_bd_intf_pins top_system_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]

  # Create port connections
  connect_bd_net -net ad_ch1_data_0_1  [get_bd_ports ad_ch1_data] \
  [get_bd_pins top_system_0/ad_ch1_data]
  connect_bd_net -net ad_ch1_otr_0_1  [get_bd_ports ad_ch1_otr] \
  [get_bd_pins top_system_0/ad_ch1_otr]
  ...
  [get_bd_pins top_system_0/sys_clk]
  ...
  [get_bd_pins top_system_0/rst_n]
  connect_bd_net -net top_system_0_ad_ch1_clk  [get_bd_pins top_system_0/ad_ch1_clk] \
  [get_bd_ports ad_ch1_clk]
  connect_bd_net -net top_system_0_da1_clk  [get_bd_pins top_system_0/da1_clk] \
  [get_bd_ports da1_clk]
  connect_bd_net -net top_system_0_da1_data  [get_bd_pins top_system_0/da1_data] \
  [get_bd_ports da1_data]
  connect_bd_net -net top_system_0_da1_wrt  [get_bd_pins top_system_0/da1_wrt] \
  [get_bd_ports da1_wrt]
  connect_bd_net -net top_system_0_da2_clk  [get_bd_pins top_system_0/da2_clk] \
  [get_bd_ports da2_clk]
  connect_bd_net -net top_system_0_da2_data  [get_bd_pins top_system_0/da2_data] \
  [get_bd_ports da2_data]
  connect_bd_net -net top_system_0_da2_wrt  [get_bd_pins top_system_0/da2_wrt] \
  [get_bd_ports da2_wrt]
  connect_bd_net -net top_system_0_led  [get_bd_pins top_system_0/led] \
  [get_bd_ports led]
  connect_bd_net -net top_system_0_ps_keys  [get_bd_pins top_system_0/ps_keys] \
