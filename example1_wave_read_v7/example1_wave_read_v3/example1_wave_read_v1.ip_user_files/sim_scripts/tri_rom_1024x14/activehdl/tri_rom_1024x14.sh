...
#                script (type 'tri_rom_1024x14.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/stega/Desktop/example1_wave_read_v7/example1_wave_read_v3/example1_wave_read_v1.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
