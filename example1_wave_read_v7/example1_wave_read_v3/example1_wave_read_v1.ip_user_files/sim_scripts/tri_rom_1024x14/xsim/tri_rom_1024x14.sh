...
#
# Script generated by Vivado on Sat May 30 16:54:14 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tri_rom_1024x14.sh
...
#
# Usage        : tri_rom_1024x14.sh
#                tri_rom_1024x14.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tri_rom_1024x14.sh [-rerun]
#                tri_rom_1024x14.sh [-reset_run]
#                tri_rom_1024x14.sh [-clean]
#                tri_rom_1024x14.sh [-reset_log]
#                tri_rom_1024x14.sh [-help]
#
...
export RDI_DATADIR="D:/for_fpga/2025.2/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_22 -L smartconnect_v1_0 -L processing_system7_vip_v1_0_24 -L xilinx_vip"

# simulation root library directory
sim_lib_dir="xsim.dir"

# script info
echo -e "tri_rom_1024x14.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tri_rom_1024x14.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tri_rom_1024x14 xil_defaultlib.tri_rom_1024x14 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tri_rom_1024x14 -key {Behavioral:sim_1:Functional:tri_rom_1024x14} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5e13.protoinst" -protoinst "protoinst_files/zynq_system.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/for_fpga/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tri_rom_1024x14.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tri_rom_1024x14.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tri_rom_1024x14.sh [-help]\n\
Usage: tri_rom_1024x14.sh [-step]\n\
Usage: tri_rom_1024x14.sh [-lib_map_path]\n\
Usage: tri_rom_1024x14.sh [-rerun]\n\
Usage: tri_rom_1024x14.sh [-reset_run]\n\
Usage: tri_rom_1024x14.sh [-clean]\n\
Usage: tri_rom_1024x14.sh [-reset_log]\n\
Usage: tri_rom_1024x14.sh [-keep_index]\n\
Usage: tri_rom_1024x14.sh [-noclean_files]\n\n\
