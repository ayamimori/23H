...
#
# Script generated by Vivado on Sat May 30 16:19:05 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : zynq_system.sh
...
#
# Usage        : zynq_system.sh
#                zynq_system.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                zynq_system.sh [-rerun]
#                zynq_system.sh [-reset_run]
#                zynq_system.sh [-clean]
#                zynq_system.sh [-reset_log]
#                zynq_system.sh [-help]
#
...
# script info
echo -e "zynq_system.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./zynq_system.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb zynq_system.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./zynq_system.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: zynq_system.sh [-help]\n\
Usage: zynq_system.sh [-step]\n\
Usage: zynq_system.sh [-lib_map_path]\n\
Usage: zynq_system.sh [-rerun]\n\
Usage: zynq_system.sh [-reset_run]\n\
Usage: zynq_system.sh [-clean]\n\
Usage: zynq_system.sh [-reset_log]\n\
Usage: zynq_system.sh [-keep_index]\n\
Usage: zynq_system.sh [-noclean_files]\n\n\
